...
<head>
    ...
    <link rel="stylesheet" href="/check/Public/Home/css/iphone.css">
...
<div id="background">
    <div class="top">
        ...
        <input type="hidden" id="program_id" name="<?php echo ($program_id); ?>">
        <span><img src="/check/Public/Home/images/icon3.png"><p id="list" class="li"></p><?php echo ($title); ?></span>
    </div>
        ...
        <div class="mid_bb">
            <ul>
                ...
                <li id="mid_bb_b" style="display: none">
                    ...
                    <p class="start_p">
                        <input type="file" id="filepicker" onchange="change()">
                        <img src="/check/Public/Home/images/index3/icon13.png"  id="start">
                        <img src="/check/Public/Home/images/index3/icon5.png"  id="start1" style="display: none">
    ...
    <div class="but">
        <ul>
            <li id="but_aa"><a class="Jumps"> <img src="/check/Public/Home/images/index3/icon1.png"></a></li>
            <li><a href="<?php echo U('index2');?>" class="jump" onclick="return confirm('确认返回吗')"><img src="/check/Public/Home/images/index3/icon2.png"></a> </li>
        </ul>
    </div>
</div>
</body>
