...
<body>
    <div id="background">
        ...
        <div class="mid">
            <ul>
                <li><span>转向架静载试验台</span></li>
                <li><a href="index1.html" onclick="load_sound(url)"><img src="/check/Public/Home/images/index2/icon5.png" onclick="load_sound(url)"></a></li>
            </ul>
            <img src="/check/Public/Home/images/index2/icon2.png" alt="">
        </div>
        <div class="center">
            <p>检查：标准/方法/工具：</p>
            <div class="center_aa">完整、干净/目视外观检查</div>
        </div>
        <div class="but">
            <ul>
                <li><a href="index4.html" class="Jumps" onclick="load_sound(url)"><img src="/check/Public/Home/images/index2/icon3.png" onclick="load_sound(url)"></a>*确认无误可点击上传保存按钮</li>
                <li onclick="load_sound(url)"><a href="" class="Jump" onclick="load_sound(url)"><img src="/check/Public/Home/images/index2/icon4.png" onclick="load_sound(url)"></a>*出现问题状况可点击申报按钮</li>
            </ul>
        </div>
    </div>
</body>
...
<script>
    ...
    $(function () {
        ...
        if(isAndroid){
            // 进入安卓版
            $('.but ul li a.Jump').attr('href','index3.html?name='+name);
        }else if(isiOS){
            // 进入苹果版
            $('.but ul li a.Jump').attr('href','iphone.html?name='+name);
        }else{
            // 进入安卓版
            $('.but ul li a.Jump').attr('href','index3.html?name='+name);
        }
