	    	    ...
	    	    <form action="" method="post" >
	    	    	<ul>
	    	    		...
	    	    		<li>
	    	    			...
	    	    			<input name="address_name" id="address_name" value="<?php echo ($result['address_name']); ?>" />
	    	    			<input type="hidden" id="address_id" value="<?php echo ($id); ?>">
	    	    		</li>
	    	    		<li>
	    	    		<label for="username">详细地址</label>
	    	    			<input name="address_detail" id="address_detail" value="<?php echo ($result['address_detail']); ?>" />
	    	    		</li>
	    	    		<li>
	    	    			<label for="name">联系手机：</label>
	    	    			<input name="address_phone" id="address_phone" value="<?php echo ($result['address_phone']); ?>" />
	    	    		</li>
	    	    		<li>
	    	    			<label for="email">邮箱：</label>
	    	    			<input name="address_email" id="address_email" value="<?php echo ($result['address_email']); ?>" />
	    	    		</li>
	    	    		<li>
	    	    			<label for="name">固定电话：</label>
	    	    			<input name="address_tel" id="address_tel" value="<?php echo ($result['address_tel']); ?>" />
	    	    		</li>
	    	    		<li>
...
$('#submit').click(function(msg){
	...
	$.post("<?php echo U('Home/Center/change');?>",{id:id,address_name:address_name,address_detail:address_detail,address_phone:address_phone,address_email:address_email,address_tel:address_tel,address_city:address_city,address_area:address_area,address_way:address_way},function(data){
		if(data.code==1){
			// 修改成功
			alert(data.info);
			history.back(-1);
