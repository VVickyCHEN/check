...
<head>
    ...
    <script type="text/javascript" src="https://api.map.baidu.com/api?v=2.0&ak=nLsK9qUii8uBZlkPAQUozAf9mR5xNVZF&s=1"></script>
    <title></title>
</head>
<body>
...
 }
    ...
    if(far>=100){
        ...
        allmap.style.display = 'block';
	 	...
	 	window.location.href="<?php echo U('Index/load');?>";
