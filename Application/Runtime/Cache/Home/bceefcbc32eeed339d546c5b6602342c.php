...
<body>
	    ...
	    <div id="middle">
	    	<div>
	    		<div>
		    		<p>付款成功，我们会尽快安排发货</p>
		    		<p>订单正在处理中，发货后订单内显示物流的联系方式，如有必要，您可以和对方联系。</p>
		    		<ul>
		    			<li>寄送至：广东省广州市天河区体育西路168号（时尚天河） </li>
		    			<li>
		    				<span>付款金额：</span>
		    			...
		    			<li>
		    				<p><a href="<?php echo U('Center/order_detail');?>">查看订单</a></p>
		    				<p><a href="<?php echo U('Product/shop_list');?>">继续购买宝贝</a></p>
		    			</li>
		    		</ul>
		    	</div>
	    	</div>
	    ...
	    <script type="text/javascript" src="/shiji/Public/Home/js/pay_success.js" ></script>
	</body>
</html>