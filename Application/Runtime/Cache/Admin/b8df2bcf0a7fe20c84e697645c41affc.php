...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" value="" placeholder="" id="pass" >
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" value="" placeholder="" id="gender" >
		</div>
	</div>
	<div class="row cl">
...
$('#submit').click(function(msg){
	...
	//判断提交的内容是否为空
	if(username==''||password==''||pass==''||nicheng==''||email==''||phone==''){ 
	...
	//$.post{发送的地址，内容，回调}
	$.post(
		"<?php echo U('Admin/Manage/append');?>",
