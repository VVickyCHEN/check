...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" value="" placeholder="" id="style_name" >
		</div>
	</div>
	<div class="row cl">
...
$('#submit').click(function(msg){
	...
	//判断提交的内容是否为空
	if(style_name==''){ 
		layer.alert('款式名称不可为空');return false;
	}

	//将内容发送到PHP
	//$.post{发送的地址，内容，回调}
	$.post(
		"<?php echo U('Admin/Style/append');?>",{style_name:style_name},function(data){
			if(data.code==1){
				// 数据插入成功
