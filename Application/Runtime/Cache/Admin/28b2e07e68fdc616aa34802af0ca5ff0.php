...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="hidden" class="input-text" value="<?php echo ($data["hall1_id"]); ?>" placeholder="" id="hall1_id" >
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<textarea class="input-text" style="width: 300px;height: 300px;" id="hall1_wenzi" name="hall1_wenzi"><?php echo ($data["hall1_wenzi"]); ?></textarea>
		</div>
	</div>
...
submit.onclick=function(event){
	...
	$.ajax({
		...
		// dataType:'json',
		// 提交地址
		url:"<?php echo U('Admin/hall1/edit');?>",
		// async:true：异步提交
		async:true,
		data:fd,
