...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('Admin/timestamp/append');?>" method="post" enctype="multipart/form-data" id="form-admin-add">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
		<div class="formControls col-xs-8 col-sm-6">
			<input class="input-text" type="input" name="timestamp" id="timestamp">
		</div>
	</div>
