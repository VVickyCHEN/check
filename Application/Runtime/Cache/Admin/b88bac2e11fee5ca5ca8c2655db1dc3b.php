...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>	
				<tr class="text-c">
				<?php if(is_array($manager)): $i = 0; $__LIST__ = $manager;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foo): $mod = ($i % 2 );++$i;?><td><?php echo ($foo["id"]); ?></td>
					...
					<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="edit('管理员编辑','edit.html?id=<?php echo ($foo["id"]); ?>',<?php echo ($foo["category_id"]); ?>,'800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
					<a title="删除" href="javascript:;" onclick="del(this,<?php echo ($foo["id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td><?php endforeach; endif; else: echo "" ;endif; ?>
				</tr>
		</tbody>
	</table>
</div>
