...
<article class="page-container">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-3">
            <input type="text" class="input-text" value="" placeholder="" id="product_num" name="product_num" >
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-3">
            <input type="text" class="input-text" value="" placeholder="" id="product_price" name="product_price" >
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3">产品款式：</label>
        <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:250px;">
                <?php if(is_array($style)): $i = 0; $__LIST__ = $style;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foo): $mod = ($i % 2 );++$i; echo ($foo["style_name"]); ?>：<input type="radio" id="style_id" name="style_id" value="<?php echo ($foo["style_id"]); ?>"/>
...
$('#submit').click(function(msg){
	...
	var style_id=$('#style_id:checked').val();		// 款式id

	//将内容发送到PHP
	//$.post{发送的地址，内容，回调}
	$.post("<?php echo U('Admin/ProductStyle/append');?>",{product_id:product_id,product_num:product_num,product_price:product_price,style_id:style_id},function(data){
