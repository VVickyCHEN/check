...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="hidden" class="input-text" value="<?php echo ($data["hallimg_id"]); ?>" placeholder="" id="hallimg_id" >
		</div>
	</div>
...
submit.onclick=function(event){
	...
	var fd = new FormData();
	// 添加数据到fd
	fd.append("hallimg_id",$('#hallimg_id').val());				//轮播图ID
	...
	$.ajax({
		...
		// dataType:'json',
		// 提交地址
		url:"<?php echo U('Admin/hallimg/edit');?>",
		// async:true：异步提交
		async:true,
		data:fd,
