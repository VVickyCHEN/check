...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text" value="" placeholder="" id="region_name" >
		</div>
	</div>
	<div class="row cl">
...
$('#submit').click(function(msg){
	...
	//将内容发送到PHP
	$.post(
		"<?php echo U('Admin/Region/append');?>",{region_name:region_name},function(data){
			if(data.code==1){
				// 数据插入成功
