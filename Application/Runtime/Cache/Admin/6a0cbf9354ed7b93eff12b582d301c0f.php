...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<textarea text style="width: 300px;height: 100px;" id="choice_content" name="choice_content"></textarea>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-8">
			<input type="text" class="input-text" value="" placeholder="" id="choice_a" >
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-8">
			<input type="text" class="input-text" value="" placeholder="" id="choice_b" >
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-8">
			<input type="text" class="input-text" value="" placeholder="" id="choice_c" >
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-8">
			<input type="text" class="input-text" value="" placeholder="" id="choice_d" >
		</div>
	</div>
...
$('#submit').click(function(msg){
	...
	//将内容发送到PHP
	$.post("<?php echo U('Admin/Choice/append');?>",{choice_content:choice_content,choice_a:choice_a,choice_b:choice_b,choice_c:choice_c,choice_d:choice_d,choice_true:choice_true},function(data){
			if(data.code==1){
				// 数据修改成功
