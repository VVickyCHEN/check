...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('Admin/program/append');?>" method="post" enctype="multipart/form-data" id="form-admin-add">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
		<div class="formControls col-xs-8 col-sm-6">
			<input class="input-text" type="input" name="title" id="title">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-6">
			<input class="input-text" type="input" value="" name="standard" id="standard">
		</div>
	</div>
