...
<link rel="stylesheet" type="text/css" href="/check/Public/Admin/static/h-ui/css/page.css">
<body>
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td><img style="width: 100px;height: 100px;" src="/check/Public/<?php echo (ltrim($foo["user_img"],'./Public')); ?>"></td>
