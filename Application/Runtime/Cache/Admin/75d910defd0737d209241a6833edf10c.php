...
<![endif]-->
<title>第一展厅管理列表</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 第一展厅管理 <span class="c-gray en">&gt;</span> 第一展厅列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="9">第一展厅列表</th>
			</tr>
			<tr class="text-c">
				<th width="50">ID</th>
				<th width="100">画板</th>
		...
		<tbody>
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$foo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					<td><?php echo ($foo["hall1_id"]); ?></td>
					<td><img  src="/gt/Public/<?php echo (ltrim($foo["hall1_thumb"],'./Public')); ?>"></td>
					<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="edit('画板编辑','<?php echo U('Admin/Hall1/edit');?>?id=<?php echo ($foo["hall1_id"]); ?>',<?php echo ($foo["hall1_id"]); ?>,'800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
					</td>
