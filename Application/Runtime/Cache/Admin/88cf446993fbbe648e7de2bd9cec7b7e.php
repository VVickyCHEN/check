...
<article class="page-container">
	<form class="form form-horizontal" action="<?php echo U('Admin/timestamp/edit');?>" method="post" id="form-admin-add" enctype="multipart/form-data" >
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
		<div class="formControls col-xs-8 col-sm-6">
			<input class="input-text" type="input" value="<?php echo ($data["timestamp"]); ?>" name="timestamp" id="timestamp">
