...
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">第一厅：</label>
		<div class="formControls col-xs-8 col-sm-3" style="padding-top: 3px;">
			已学习{}板/共3板
		</div>
	</div>

	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">第二厅：</label>
		<div class="formControls col-xs-8 col-sm-3" style="padding-top: 3px;">
			已学习{}板/共3板
		</div>
	</div>
