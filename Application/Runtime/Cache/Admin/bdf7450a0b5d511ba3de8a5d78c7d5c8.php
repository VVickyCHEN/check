...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="hidden" class="input-text" value="<?php echo ($data["hall2_id"]); ?>" placeholder="" id="hall2_id" >
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
			<textarea class="input-text" style="width: 300px;height: 300px;" id="hall2_wenzi" name="hall2_wenzi"><?php echo ($data["hall2_wenzi"]); ?></textarea>
		</div>
	</div>
...
submit.onclick=function(event){
	...
	var fd = new FormData();
	// 添加数据到fd
	fd.append("hall2_id",$('#hall2_id').val());				//轮播图ID
	...
	$.ajax({
		...
		// dataType:'json',
		// 提交地址
		url:"<?php echo U('Admin/hall2/edit');?>",
		// async:true：异步提交
		async:true,
		data:fd,
